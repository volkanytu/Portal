...
{
    public class PortalDao : BaseDao<Portal>
    {
        private IMsCrmAccess _msCrmAccess;
        private ISqlAccess _sqlAccess;

        public PortalDao(IMsCrmAccess msCrmAccess, ISqlAccess sqlAccess)
        ...
        {
            get { return "new_portal"; }
        }

        public override string GetQuery
        {
            get { return PortalQueries.GET_QUERY; }
        }
