    ...
    public class PostCreate : IPlugin
    {
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            try
            {
                ...
                MsCrmResultObject limitRes = ScoreHelper.GetScoreLimitsByType(ScoreType.EditVideo, sda);
                ...
                if (limitRes.Success)
                {
                    ...
                    for (int i = 0; i < lstLimits.Count; i++)
                    {
                        ...
                        recCount = VideoHelper.GetVideoEditCount(portal.Id, user.Id, start, end, sda);
