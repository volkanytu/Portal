...
namespace GK.WindowsServices.ProcessDiscoveryForms.lotusService {
    ...
    public partial class UcretsizKesifService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void CREATERECORDAsync(string PASSWORD, double ID, string AD, string SOYAD, string EMAIL, string TEL, string SAAT, string IL, string ILCE, string KONUTTIPI, string OKUNDU, string BASVURUTARIH, string NEREDEGORDUNUZ) {
            this.CREATERECORDAsync(PASSWORD, ID, AD, SOYAD, EMAIL, TEL, SAAT, IL, ILCE, KONUTTIPI, OKUNDU, BASVURUTARIH, NEREDEGORDUNUZ, null);
        }
        
        /// <remarks/>
        public void CREATERECORDAsync(string PASSWORD, double ID, string AD, string SOYAD, string EMAIL, string TEL, string SAAT, string IL, string ILCE, string KONUTTIPI, string OKUNDU, string BASVURUTARIH, string NEREDEGORDUNUZ, object userState) {
            ...
            this.InvokeAsync("CREATERECORD", new object[] {
                        ...
                        OKUNDU,
                        BASVURUTARIH,
                        NEREDEGORDUNUZ}, this.CREATERECORDOperationCompleted, userState);
        }
