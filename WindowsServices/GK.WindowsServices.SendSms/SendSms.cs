...
namespace GK.WindowsServices.SendSms
{
    public partial class SendSms : ServiceBase
    {
        ...
        {
            FileLogHelper.LogFunction(this.GetType().Name,"SendSms_OnStart_SERVICE_STARTED", LOG_PATH);
        ...
        {
            FileLogHelper.LogFunction(this.GetType().Name,"SendSms_OnStop_SERVICE_STOPPED", LOG_PATH);
        ...
        void timer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            {
                FileLogHelper.LogFunction(this.GetType().Name,"SendSms_timer_Elapsed_EXCEPTION:" + ex.Message, ERROR_LOG_PATH);
            }
        }
    }
}
